      ...
      <Section padding="0" alignItems="center" backgroundColor={'#F5F3F1'}>
        ...
        >
          ...
          >
            ...
            >
              Our Private Air Charter Services offers
            </Text>
          </div>
        </Container>
          ...
          info={
            <>
              <Text
                ...
                tag="p"
              >
                SkyJet Elite is committed to providing the highest level of safety and security for
                our clients. Making sure every individual flight is managed under the highest safety
                standards requires a proactive, company-wide approach. We are proud to meet and
                exceed the standards set forth by the FAA and the Department of Transportation; as
                well as our independent third-party safety auditors ARGUS and Wyvern.
              </Text>
              <br />
              <Text
                fontFamily="Inter"
              ...
              >
                There is no higher priority to SkyJet Elite than the safety and security of our
                clients and employees. To aid in the prevention of exposure to COVID-19, SkyJet
                Elite has implemented a comprehensive safety protocol and enhanced our already
                stringent aircraft cleaning standards based on recommendations from the Centers for
                Disease Control and Prevention (CDC), World Health Organization (WHO), the
                Occupational Health and Safety Administration (OSHA), and the Federal Aviation
                Administration (FAA). Every aircraft is treated with MicroShield 360, an
                antimicrobial biostatic finish which prevents pathogens from living on any treated
                surface. It is effective on MRSA, E. Coli, H1N1 Influenza, Common Cold, Strep,
                COVID-19, and 90+ additional pathogens. (INLUDE SINGLE PAGE BROCHURE FOR MICROSHIELD
                360).
              </Text>
              <br />
              <Text
              ...
              >
                Our crews and staff adhere to the standards and measures set forth by the CDC, FAA,
                and OSHA for individual health and public safety.
              </Text>
            </>
          }
        ></BodyAircraftManagement>
